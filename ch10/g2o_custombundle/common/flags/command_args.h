...
#include <vector>
#include <iostream>
#include <sstream> //C++引入ostringstream、istringstream、stringstream这三个类，要使用他们创建对象就必须包含<sstream>这个头文件
...
class CommandArgs
{
  ...
  public:
    ...
    /** add a bool parameter, if found on the command line, will toggle（切换） defValue */
